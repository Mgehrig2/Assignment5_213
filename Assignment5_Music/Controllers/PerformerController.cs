...
namespace Assignment5_Music.Controllers
{
    public class PerformerController : Controller
    {
        ...
        public PerformerController(Assignment5_MusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string musicGenre, string musicPerformer)
        {
            ...
            var test = performerQuery.Distinct().ToListAsync();
            ...
            {
                musics = musics.Where(x => x.Performer == musicPerformer);
            }
